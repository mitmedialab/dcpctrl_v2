...
m3dscope_old (should work on any MATLAB version but I strongly encourage 
you to use the new one if you are running R2014b or later).
...
(sfun3d.m) which is more efficient, accepts LineStyle and Marker as 
parameters, and has a transposed (and more sensible) input ordering, 
(that is the expected input vector now is x1,y1,z1,x2,y2,x2, ... 
 instead of the three vectors x1,x2,... , y1,y2,... , and z1,z2,... )

Have a look at either models m3dscope_new.mdl or lorenz.mdl to see
an usage example of this new block.
